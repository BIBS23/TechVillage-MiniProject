        ...
        child: const SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                Text(
'''TechVillage is a powerful e-commerce platform designed specifically for the residents of this panchayat. Our app aims to revolutionize local buying and selling, while also providing essential services and keeping the community informed about grants and opportunities provided by the panchayat.
