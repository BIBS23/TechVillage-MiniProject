...
class ChickenPage extends StatefulWidget {
  ...
  @override
  State<ChickenPage> createState() => _TailorPageState();
}

class _TailorPageState extends State<ChickenPage> {
  @override
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ContactTile(
                          ...
                          route: ProfilePage(  profimg: documentSnapshot['profimg'],name: documentSnapshot['name'],profile: documentSnapshot['about'],collection1: 'products',collection2: 'sellers',document: 'chicken'),
                        );
                      }),
                );
              }
